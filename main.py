...
class SubCriterionScore(BaseModel):
    ...
    rationale: Optional[str] = None # ⭐ 新增：AI 評分理由
...
def call_gemini_for_scoring_sync(company_name: str, pdf_text: str, website_url: str) -> dict:
    ...
    - ⭐ **重要**: 對於每一個 `sub_criteria` 項目，你都必須提供一個 `rationale` 欄位，用一句话簡潔地說明你給予該分數的**主要理由或文本證據**。
        ...
        {{
          ...
          "sections": [
            {{
              ...
              "criteria": [
                {{ "title": "重大性議題", "max_score": 8.0, "score": 0.0, "sub_criteria": [ 
                ...
                {{ "title": "利害關係人共融", "max_score": 6.0, "score": 0.0, "sub_criteria": [ {{"title": "是否清楚列出組織的利害關係人之種類與意義", "max_score": 1.0, "score": 0.0, "rationale": "..."}}, {{"title": "是否清楚說明各種利害關係人議合之方法", "max_score": 2.0, "score": 0.0, "rationale": "..."}}, {{"title": "是否清楚說明各種利害關係人關注之議題", "max_score": 1.0, "score": 0.0, "rationale": "..."}}, {{"title": "是否清楚說明組織針對各項議題的因應之道", "max_score": 2.0, "score": 0.0, "rationale": "..."}} ] }},
                ...
                {{ "title": "組織介紹", "max_score": 2.0, "score": 0.0, "sub_criteria": [ {{"title": "揭露資訊：主要產品與服務、財務績效、地理分布、員工資訊、整體環境與組織營運之關聯性等", "max_score": 2.0, "score": 0.0, "rationale": "..."}} ] }},
                {{ "title": "重大永續規範執行及資訊揭露", "max_score": 12.0, "score": 0.0, "sub_criteria": [ {{"title": "氣候相關財務揭露(TCFD)", "max_score": 3.0, "score": 0.0, "rationale": "..."}}, {{"title": "永續會計準則委員會準則(SASB)", "max_score": 3.0, "score": 0.0, "rationale": "..."}}, {{"title": "自然相關財務揭露(TNFD)", "max_score": 3.0, "score": 0.0, "rationale": "..."}}, {{"title": "國際財務報導準則(IFRS) S1,S2揭露", "max_score": 3.0, "score": 0.0, "rationale": "..."}} ] }}
              ]
            }},
            {{
              "title": "可信度", "max_score": 35.0, "score": 0.0, "ai_comment": "針對「可信度」的評論。",
              "criteria": [
                {{ "title": "管理流程", "max_score": 10.0, "score": 0.0, "sub_criteria": [ {{"title": "報告揭露採用之指引與準則", "max_score": 1.0, "score": 0.0, "rationale": "..."}}, {{"title": "是否揭露報告書主要負責單位", "max_score": 1.0, "score": 0.0, "rationale": "..."}}, {{"title": "報告書的管理方式", "max_score": 4.0, "score": 0.0, "rationale": "..."}}, {{"title": "針對各項重大性議題皆說明管理方針", "max_score": 4.0, "score": 0.0, "rationale": "..."}} ] }},
                {{ "title": "利害關係人回應", "max_score": 5.0, "score": 0.0, "sub_criteria": [ {{"title": "針對利害關係人關注之議題，組織是否實際回應議題，並提出相對應之作為、策略與規劃等政策", "max_score": 2.0, "score": 0.0, "rationale": "..."}}, {{"title": "組織是否有針對組織鑑別出之實質性議題進行回應，並提出相對應之策略與作為", "max_score": 3.0, "score": 0.0, "rationale": "..."}} ] }},
                {{ "title": "治理", "max_score": 5.0, "score": 0.0, "sub_criteria": [ {{"title": "是否有說明組織組織針對永續報告的責任單位", "max_score": 1.0, "score": 0.0, "rationale": "..."}}, {{"title": "報告書是否有說明董事會的薪酬與永續績效的連結性", "max_score": 2.0, "score": 0.0, "rationale": "..."}}, {{"title": "報告書是否有揭露組織組織的風險與可能之機會(因應之道)", "max_score": 1.0, "score": 0.0, "rationale": "..."}}, {{"title": "組織績效指標管理方針是否與組織永續原則一致", "max_score": 1.0, "score": 0.0, "rationale": "..."}} ] }},
                {{ "title": "績效", "max_score": 5.0, "score": 0.0, "sub_criteria": [ {{"title": "績效之揭露是否完整(重大性議題涵蓋經濟、環境與社會，是否有質化的說明與數據)", "max_score": 2.0, "score": 0.0, "rationale": "..."}}, {{"title": "重大性議題是否有量化的圖表說明", "max_score": 1.0, "score": 0.0, "rationale": "..."}}, {{"title": "是否有揭露過去負面訊息", "max_score": 1.0, "score": 0.0, "rationale": "..."}}, {{"title": "績效的呈現是否易懂", "max_score": 1.0, "score": 0.0, "rationale": "..."}} ] }},
                {{ "title": "保證/確信", "max_score": 10.0, "score": 0.0, "sub_criteria": [ {{"title": "是否已建立永續資訊編制內部控制制度及相關流程", "max_score": 2.0, "score": 0.0, "rationale": "..."}}, {{"title": "永續資訊編制內部控制制度及其內部稽核執行情形說明", "max_score": 3.0, "score": 0.0, "rationale": "..."}}, {{"title": "是否有外部第三方獨立保證/確信之佐證資料", "max_score": 2.0, "score": 0.0, "rationale": "..."}}, {{"title": "外部保證是否有說明保證等級、範疇與方法(中度/有限等級者最多得2分，高度/合理等級者做多可得3分)", "max_score": 3.0, "score": 0.0, "rationale": "..."}} ] }}
              ]
            }},
            {{
              "title": "溝通性", "max_score": 25.0, "score": 0.0, "ai_comment": "針對「溝通性」的評論。",
              "criteria": [
                {{ "title": "展現", "max_score": 10.0, "score": 0.0, "sub_criteria": [ {{"title": "版面是否圖表與文字說明比例恰當，內容清晰且易於閱讀", "max_score": 3.0, "score": 0.0, "rationale": "..."}}, {{"title": "具有英文版報告書", "max_score": 3.0, "score": 0.0, "rationale": "..."}}, {{"title": "展現創新的資訊呈現方式", "max_score": 2.0, "score": 0.0, "rationale": "..."}}, {{"title": "報告書之份量是否適當(頁數120-150頁為參考範圍)", "max_score": 2.0, "score": 0.0, "rationale": "..."}} ] }},
                {{ "title": "利害關係人共融", "max_score": 5.0, "score": 0.0, "sub_criteria": [ {{"title": "組織永續報告書是否公開下載", "max_score": 1.0, "score": 0.0, "rationale": "..."}}, {{"title": "是否有說明利害關係人議合(溝通資訊)的方法", "max_score": 2.0, "score": 0.0, "rationale": "..."}}, {{"title": "利害關係人議合的結果，組織是否公開揭露其相對應的回應與作為", "max_score": 2.0, "score": 0.0, "rationale": "..."}} ] }},
                {{ "title": "架構", "max_score": 10.0, "score": 0.0, "sub_criteria": [ {{"title": "是否清楚整理並呈現本年度の亮點作為報告書的總結", "max_score": 3.0, "score": 0.0, "rationale": "..."}}, {{"title": "完整的索引設計(包括GRI, SASB及其他重要規範等)", "max_score": 3.0, "score": 0.0, "rationale": "..."}}, {{"title": "報告書附有清楚的連結，使讀者可透過網頁的說明獲得更細節的資訊", "max_score": 2.0, "score": 0.0, "rationale": "..."}}, {{"title": "架構呈現完整易於查閱", "max_score": 2.0, "score": 0.0, "rationale": "..."}} ] }}
              ]
            }}
          ]
        }},
          ...
          "sections": [
            {{
              ...
              "criteria": [
                ...
                {{ "title": "網頁管理與即時更新", "max_score": 4.0, "score": 0.0, "sub_criteria": [ {{"title": "判斷依據：由最新消息觀察網頁是否為最新訊息、是否即時更新", "max_score": 4.0, "score": 0.0, "rationale": "..."}} ] }},
                {{ "title": "電子版報告書與關鍵資訊連結", "max_score": 4.0, "score": 0.0, "sub_criteria": [ {{"title": "按照永續報告定義，須符合環境、社會與治理(ESG)以及供應鏈管理等四項議題之揭露", "max_score": 4.0, "score": 0.0, "rationale": "..."}} ] }},
                {{ "title": "多元媒體展現", "max_score": 4.0, "score": 0.0, "sub_criteria": [ {{"title": "文字說明", "max_score": 1.0, "score": 0.0, "rationale": "..."}}, {{"title": "圖表說明", "max_score": 1.0, "score": 0.0, "rationale": "..."}}, {{"title": "使用影片", "max_score": 1.0, "score": 0.0, "rationale": "..."}}, {{"title": "互動式網頁", "max_score": 1.0, "score": 0.0, "rationale": "..."}} ] }},
                {{ "title": "溝通回饋管道與社群網絡互動", "max_score": 4.0, "score": 0.0, "sub_criteria": [ {{"title": "線上回饋機制之應用(網路填寫或連結至電子信箱)", "max_score": 1.0, "score": 0.0, "rationale": "..."}}, {{"title": "線上互動式機制之應用", "max_score": 1.0, "score": 0.0, "rationale": "..."}}, {{"title": "社交網站之應用", "max_score": 1.0, "score": 0.0, "rationale": "..."}}, {{"title": "提供訂閱電子報", "max_score": 1.0, "score": 0.0, "rationale": "..."}} ] }}
              ]
            }}
          ]
        }}
